...
const certificates: Certificate[] = [
  ...
  { title: "SCRUMAGIZE – Agile Workshop", issuer: "Leo Club of IIT / Winhe Software Eng.",  category: "Methodology",  icon: "🔄" },
];
...
// Marquee strip — scrolling ticker of issuers
const issuers = ["LinkedIn Learning", "University of Moratuwa", "Informatics Institute of Technology", "Leo Club of IIT", "Winhe Software Academy", "ESOFT"];
...
export default function CertificatesSection() {
  return (
    <section id="certificates" className="py-28 bg-[#050507] text-white overflow-hidden">
      ...
      <div className="relative mb-12 overflow-hidden border-y border-white/5 bg-white/[0.015] py-3">
        <style>{`
